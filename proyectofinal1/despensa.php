    ...
    <main>
     ...
     <a href="categorias.php" class="boton-volver">&#8592; Regresar</a>
        ...
        <div class="cuadricula">
         <div class="producto">
             <img src="imagenes/frijol blanco.jpg" alt="imagenes/frijol.wedp">
             <h3>Frijol Blanco</h3>
             <p>Precio: $3.200</p>
            ...
            <div class="producto">
             <img src="imagenes/garbanzos.jpg" alt="Imagen 2">
             <h3>Garbanzos</h3>
             <p>Precio: $3.440</p>
              <a href="#" class="boton-carrito">Agregar al Carrito</a>
            </div>
            ...
            <div class="producto">
             <img src="imagenes/maiz.jpg" alt="Imagen 3">
             <h3>Bolsa De Maiz</h3>
             <p>Precio: $4.500</p>
              <a href="#" class="boton-carrito">Agregar al Carrito</a>
            </div>
            ...
            <div class="producto">
             <img src="imagenes/frijol.jpg" alt="Imagen 3">
